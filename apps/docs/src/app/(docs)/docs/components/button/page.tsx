      ...
      >
        <div className="flex flex-col gap-12">
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-slate-400">
              Primary hierarchy is standardized across the design system.
            </p>
            <Playground
  ...
  <Button variant="outline" rightIcon={<Zap className="h-4 w-4" />}>
    Execute
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-slate-400">
              Default, active, disabled and loading states.
            </p>
            <Playground
              code={`<div className="flex gap-4">
  <Button>Default</Button>
  <Button className="active:translate-y-px" aria-pressed>Active</Button>
  <Button variant="primary-subtle" disabled>Disabled</Button>
  <Button isLoading>Processing...</Button>
          ...
          props={[
            {
              ...
              type: '"primary" | "primary-subtle" | "primary-outline" | "neon" | "secondary" | "success" | "danger" | "ghost" | "outline"',
            ...
            },
            {
              property: 'asChild',
              description:
                'Change the underlying component to the passed child element.',
              type: 'boolean',
              defaultValue: 'false',
            },
          ]}
      ...
      >
        <ul className="list-disc pl-5 space-y-2 text-slate-400">
          <li>
            Uses the native{' '}
            <code className="text-cyan-400 font-mono text-sm bg-cyan-950/50 px-1 rounded">
              {'<button>'}
            </code>{' '}
            element.
          </li>
          <li>
            Keyboard focus is clearly visible with an emerald ring to comply
            with WCAG 2.2 AA.
          </li>
          <li>
            When{' '}
            ...
            is true, the button adds{' '}
            <code className="text-cyan-400 font-mono text-sm bg-cyan-950/50 px-1 rounded">
              {'aria-disabled="true"'}
            </code>{' '}
            to prevent interaction while remaining readable.
          </li>
          <li>
            Icon-only buttons should always include an{' '}
            <code className="text-cyan-400 font-mono text-sm bg-cyan-950/50 px-1 rounded">
              aria-label
            </code>{' '}
            or{' '}
      ...
      >
        <ul className="list-disc pl-5 space-y-2 text-slate-400">
          <li>
            <strong>Hierarchy:</strong> Use only one primary button per screen
            or section to guide the user&apos;s primary action.
          </li>
          <li>
            <strong>Clarity:</strong> Button text should be clear, concise, and
            action-oriented (e.g., &quot;Deploy Protocol&quot; instead of
            &quot;Submit&quot;).
          </li>
          <li>
            <strong>Destructive Actions:</strong> Always use the{' '}
            <code className="text-cyan-400 font-mono text-sm bg-cyan-950/50 px-1 rounded">
              danger
            </code>{' '}
            variant for actions that cannot be undone (e.g., deleting data,
            terminating sessions). Consider pairing with a confirmation dialog.
          </li>
        </ul>
      </ContentSection>
    </ComponentPage>
